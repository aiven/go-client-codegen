...
const (
	...
	MemberTypeProjectEventLogsRead           MemberType = "project:event_logs:read"
	...
	MemberTypeServiceMetricsRead             MemberType = "service:metrics:read"
...
func OrderByTypeChoices() []string {
	return []string{"real_name:asc", "real_name:desc", "user_email:asc", "user_email:desc", "user_id:asc", "user_id:desc"}
}
...
const (
	...
	TeamTypeProjectEventLogsRead           TeamType = "project:event_logs:read"
	...
	TeamTypeServiceMetricsRead             TeamType = "service:metrics:read"
