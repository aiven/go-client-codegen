...
func NewHandler(doer doer) GroupHandler {
	return GroupHandler{doer}
}
...
func (h *GroupHandler) UserGroupCreate(ctx context.Context, organizationId string, in *UserGroupCreateIn) (*UserGroupCreateOut, error) {
...
func (h *GroupHandler) UserGroupDelete(ctx context.Context, organizationId string, userGroupId string) error {
...
func (h *GroupHandler) UserGroupGet(ctx context.Context, organizationId string, userGroupId string) (*UserGroupGetOut, error) {
	path := fmt.Sprintf("/organization/%s/user-groups/%s", organizationId, userGroupId)
...
func (h *GroupHandler) UserGroupMemberList(ctx context.Context, organizationId string, userGroupId string) ([]Member, error) {
...
func (h *GroupHandler) UserGroupMembersUpdate(ctx context.Context, organizationId string, userGroupId string, in *UserGroupMembersUpdateIn) error {
	path := fmt.Sprintf("/organization/%s/user-groups/%s/members", organizationId, userGroupId)
	_, err := h.doer.Do(ctx, "UserGroupMembersUpdate", "PATCH", path, in)
	return err
}
func (h *GroupHandler) UserGroupUpdate(ctx context.Context, organizationId string, userGroupId string, in *UserGroupUpdateIn) (*UserGroupUpdateOut, error) {
	path := fmt.Sprintf("/organization/%s/user-groups/%s", organizationId, userGroupId)
...
func (h *GroupHandler) UserGroupsList(ctx context.Context, organizationId string) ([]UserGroup, error) {
	path := fmt.Sprintf("/organization/%s/user-groups", organizationId)
