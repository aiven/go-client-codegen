...
type Handler interface {
	// OrganizationVpcCreate create an organization VPC
	...
	// OrganizationVpcDelete delete an organization VPC
	...
	// OrganizationVpcGet get a single organization VPC
	...
	// OrganizationVpcPeeringConnectionCreate create a peering connection for an organization VPC
	...
	// OrganizationVpcPeeringConnectionDeleteById delete a peering connection from an organization VPC by peering connection ID
