...
func (h *ServiceHandler) AlloyDbOmniGoogleCloudPrivateKeyIdentify(ctx context.Context, project string, serviceName string) (*AlloyDbOmniGoogleCloudPrivateKeyIdentifyOut, error) {
...
func (h *ServiceHandler) AlloyDbOmniGoogleCloudPrivateKeyRemove(ctx context.Context, project string, serviceName string) (*AlloyDbOmniGoogleCloudPrivateKeyRemoveOut, error) {
	path := fmt.Sprintf("/v1/project/%s/service/%s/alloydbomni/google_cloud_private_key", url.PathEscape(project), url.PathEscape(serviceName))
...
func (h *ServiceHandler) AlloyDbOmniGoogleCloudPrivateKeySet(ctx context.Context, project string, serviceName string, in *AlloyDbOmniGoogleCloudPrivateKeySetIn) (*AlloyDbOmniGoogleCloudPrivateKeySetOut, error) {
	path := fmt.Sprintf("/v1/project/%s/service/%s/alloydbomni/google_cloud_private_key", url.PathEscape(project), url.PathEscape(serviceName))
