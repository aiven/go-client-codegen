...
type ServicePlanOut struct {
	...
	NodeCountMax     *int            `json:"node_count_max,omitempty"`     // Number of nodes in this service plan
	NodeCountMin     *int            `json:"node_count_min,omitempty"`     // Number of nodes in this service plan
