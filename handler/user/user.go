...
type Handler interface {
	...
	// https://api.aiven.io/doc/#tag/User/operation/AccessTokenUpdate
	...
	// https://api.aiven.io/doc/#tag/User/operation/UserAccountInvitesAccept
	...
	// https://api.aiven.io/doc/#tag/User/operation/UserAccountInvitesList
	AccountInvitesList(ctx context.Context) ([]AccountInvite, error)

	// Auth authenticate user
	// UserAuth POST /userauth
	// https://api.aiven.io/doc/#tag/User/operation/UserAuth
	...
	// https://api.aiven.io/doc/#tag/User/operation/UserAuthLoginOptions
	...
	// https://api.aiven.io/doc/#tag/User/operation/UserAuthenticationMethodDelete
	...
	// https://api.aiven.io/doc/#tag/User/operation/UserAuthenticationMethodsList
	...
	// https://api.aiven.io/doc/#tag/User/operation/CheckPasswordStrengthExistingUser
	...
	// https://api.aiven.io/doc/#tag/User/operation/CheckPasswordStrengthNewUser
	...
	// https://api.aiven.io/doc/#tag/User/operation/UserCreate
	...
	// https://api.aiven.io/doc/#tag/User/operation/UserExpireTokens
	ExpireTokens(ctx context.Context) error

	// Info get information for the current session's user
	// UserInfo GET /me
	// https://api.aiven.io/doc/#tag/User/operation/UserInfo
	...
	// https://api.aiven.io/doc/#tag/User/operation/UserLogout
	Logout(ctx context.Context) error

	// PasswordChange change user password
	// UserPasswordChange PUT /me/password
	// https://api.aiven.io/doc/#tag/User/operation/UserPasswordChange
	...
	// https://api.aiven.io/doc/#tag/User/operation/UserPasswordReset
	...
	// https://api.aiven.io/doc/#tag/User/operation/UserPasswordResetRequest
	...
	// https://api.aiven.io/doc/#tag/User/operation/TwoFactorAuthConfigure
	...
	// https://api.aiven.io/doc/#tag/User/operation/TwoFactorAuthConfigureOTP
	TwoFactorAuthConfigureOTP(ctx context.Context, in *TwoFactorAuthConfigureOtpin) (*TwoFactorAuthConfigureOtpout, error)

	// Update edit profile
	// UserUpdate PATCH /me
	// https://api.aiven.io/doc/#tag/User/operation/UserUpdate
	...
	// https://api.aiven.io/doc/#tag/User/operation/ValidateCreditCode
	...
	// https://api.aiven.io/doc/#tag/User/operation/ValidateReferralCode
	...
	// https://api.aiven.io/doc/#tag/User/operation/UserVerifyEmail
